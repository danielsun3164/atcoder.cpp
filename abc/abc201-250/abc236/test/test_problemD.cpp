...
TEST(abc236_problemD, case1) {
	check(string("") + "2\n" + "4 0 1\n" + "5 3\n" + "2", string("") + "6");
}

TEST(abc236_problemD, case2) {
	check(string("") + "1\n" + "5", string("") + "5");
}

TEST(abc236_problemD, case3) {
	check(string("") + "5\n" +
			  "900606388 317329110 665451442 1045743214 260775845 726039763 57365372 741277060 "
			  "944347467\n" +
