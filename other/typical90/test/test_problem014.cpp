...
static const string COMMAND = "problem014";

TEST(typical90_problem014, case1) {
	check(PATH + COMMAND, string("") + "1\n" + "869\n" + "120", string("") + "749");
}

TEST(typical90_problem014, case2) {
	check(PATH + COMMAND, string("") + "6\n" + "8 6 9 1 2 0\n" + "1 5 7 2 3 9", string("") + "5");
}

TEST(typical90_problem014, case3) {
	check(PATH + COMMAND, string("") + "10\n" + "31 41 59 26 53 58 97 93 23 84\n" + "17 32 5 8 7 56 88 77 29 35",
			string("") + "211");
}

TEST(typical90_problem014, case4) {
	check(PATH + COMMAND,
			string("") + "20\n"
