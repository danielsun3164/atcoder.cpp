...
static const string COMMAND = "problem015";
...
TEST(typical90_problem015, case3) {
	check(PATH + COMMAND, string("") + "3", string("") + "7\n" + "4\n" + "3");
}

TEST(typical90_problem015, case4) {
	check(PATH + COMMAND, string("") + "4", string("") + "15\n" + "7\n" + "5\n" + "4");
}

TEST(typical90_problem015, case5) {
	check(PATH + COMMAND, string("") + "7", string("") + "127\n" + "33\n" + "18\n" + "13\n" + "10\n" + "8\n" + "7");
}
